...
#  if defined( __unix__ ) || defined( __APPLE__ ) || defined( __QNXNTO__ ) || defined( __Fuchsia__ ) || defined( __HAIKU__ )
#    include <dlfcn.h>
#  elif defined( _WIN32 )
...
#  endif
      ...
      {
#  if defined( __unix__ ) || defined( __QNXNTO__ ) || defined( __Fuchsia__ ) || defined( __HAIKU__ )
